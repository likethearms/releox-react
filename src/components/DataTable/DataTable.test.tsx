...
describe('DataTable', () => {
  ...
  it('should show default noDataText', () => {
    ...
    expect(wrapper.prop('noDataIndication')()).toStrictEqual(<p style={{ margin: 0, textAlign: 'center' }}>There is nothing to show</p>);
  });
  ...
  it('should show noDataText', () => {
    ...
    expect(wrapper.prop('noDataIndication')()).toStrictEqual(<p style={{ margin: 0, textAlign: 'center' }}>Foo Bar</p>);
  });
  ...
  it('should call onChangeLoopback', () => {
    ...
    expect(spy.mock.calls).toEqual([[{ limit: 20, order: 'id ASC', skip: 0 }], [{ limit: 20, order: 'name DESC', skip: 0 }]]);
  });
